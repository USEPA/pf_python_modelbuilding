...
class Results:
    ...
    def summarize_model_stats(
        ...
        if len(metrics_in_rows) == 1:
            ...
            print(f"{'Run':<40} {'Test':<10} {'Training_CV':<15} {'External':<10} {'#_variables':<10}")
            for r in rows:
                # print(f"{r['Run']}\t{fmt3(r.get(f'{stat}_Test'))}\t{fmt3(r.get(f'{stat}_Training_CV'))}\t"
                #       f"{fmt3(r.get(f'{stat}_External'))}\t{r.get('#_variables', 'N/A')}")
                print(f"{r['Run']:<40} {fmt3(r.get(f'{stat}_Test')):<10} {fmt3(r.get(f'{stat}_Training_CV')):<15} {fmt3(r.get(f'{stat}_External')):<10} {r.get('#_variables', 'N/A'):<10}")
            ...
            print(f"{'Run':<40} {'Metric':<10} {'Test':<10} {'Training_CV':<15} {'External':<10} {'#_variables':<10}")
            for r in rows:
                stat_row = r["Metric"]
                ...
                print(f"{r['Run']:<40} {stat_row:<10} {fmt3(r.get(f'{stat_row}_Test')):<10} {fmt3(r.get(f'{stat_row}_Training_CV')):<15} {fmt3(r.get(f'{stat_row}_External')):<10} {r.get('#_variables', 'N/A'):<10}")
