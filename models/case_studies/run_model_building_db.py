...
class ModelLoader():
    @staticmethod
    def create_descriptor_embedding(session: Session, descriptor_embedding: Mapping[str, Any]):
    ...
    @staticmethod
    def create_model(session: Session, model: Mapping[str, Any]):
    ...
    @staticmethod
    def get_method_id(session, qsar_method: str):
        sql = text("""
            select m.id
